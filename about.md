...
### Use?
You can now <cy>stop misclicking those heckin' buttons</c>! Open the pop-up by <cy>pressing the new "RobTop" button</c> in that same corner. Pressing each social button in the pop-up will also open <cg>a confirmation pop-up</c> asking if you want to proceed.
